...
export const dialogues = {
  ...
  "greet-grumpy-man": {
    ...
    participants: {
      player: { name: "Hornero Billete Argentino" },
      npc: { name: "Señor Gruñón", avatar: "grumpy-man.png" },
    },
    steps: [
      {
        id: "p1",
  ...
  "greet-melancholic-woman": {
    ...
    participants: {
      player: { name: "Hornero Billete Argentino" },
      npc: { name: "Señora Melancólica", avatar: "elderly-woman.png" },
    },
    steps: [
      {
        id: "p1",
      ...
      },
      {
        ...
        text: [
          ...
          "Acaso eres un angel de la muerte? Tal vez ya me muerto después de todo.",
        ],
        next: "p6",
  ...
  "greet-mad-hologram-woman": {
    ...
    participants: {
      player: { name: "Hornero Billete Argentino" },
      npc: { name: "Señora", avatar: "hologram-madwoman.png" },
    },
    steps: [
      {
        id: "n1",
        speaker: DialogueSpeaker.NPC,
        text: ["¡Vos sos el que me quiso robar!"],
        next: "p1",
      },
      {
        id: "p1",
      ...
      },
      {
        id: "n2",
        speaker: DialogueSpeaker.NPC,
        text: ["¡Vos sos un holograma! ¡La c*nch4 de tu madre!"],
        next: "n3",
      },
      {
        id: "n3",
        speaker: DialogueSpeaker.NPC,
        text: ["¡De que te reis hijo de p*t4!"],
        next: "n4",
      },
      {
        id: "n4",
      ...
      },
      {
        id: "n5",
        speaker: DialogueSpeaker.NPC,
        text: ["¡Andate antes que te mate!"],
        next: "p3",
      },
      {
        id: "p3",
        speaker: DialogueSpeaker.NPC,
        text: ["¿Que te pasa, vieja?"],
        next: "n6",
      },
      {
        id: "n6",
        speaker: DialogueSpeaker.NPC,
        text: ["¡Andate basura, n*gr0 ignorante!"],
        next: "p4",
      },
      {
        id: "p4",
