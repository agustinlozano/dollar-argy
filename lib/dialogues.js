...
export const dialogues = {
  ...
  "greet-grumpy-old-man": {
    id: "greet-grumpy-old-man",
    participants: {
      player: { name: "Hornero Billete Argentino" },
      npc: { name: "Señor Gruñón", avatar: "old-man.png" },
    },
    steps: [
      {
        id: "p1",
  ...
  "greet-melancholic-lady": {
    id: "greet-melancholic-lady",
    participants: {
      player: { name: "Hornero Billete Argentino" },
      npc: { name: "Señora Melancólica", avatar: "old-lady.png" },
    },
    steps: [
      {
        id: "p1",
      ...
      },
      {
        ...
        speaker: DialogueSpeaker.NPC,
        text: [
          "No deberías estar verstido de esa forma, muchos se molestarían con tan solo verte.",
          "Te recomiendo que uses algún atuendo para ocultar tu naturaleza.",
          "Tal vez podrías buscar un disfraz de yuan o real brasileño.",
        ],
        next: "p6",
